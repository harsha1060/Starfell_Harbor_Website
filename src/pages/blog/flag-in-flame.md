...
title: "picoCTF Walkthrough: Cracking the 'Flag in Flame'"
date: "JAN 06, 2026"
readTime: "4 MIN READ"
author: "Harsha"
category: "cyber"
image: "/assets/images/flag-in-flame/1.webp"
---
...
## 4. Visual Analysis and Hex Extraction
...
* **Analyze:** The `logs.txt` was too big and looked like Base64 (even without padding).
* **Decode:** Converted the text blob into a binary `.jpg`.
* **Observe:** Found the Hex string visually hidden in the image.
* **Solve:** Decoded the Hex to get the flag.